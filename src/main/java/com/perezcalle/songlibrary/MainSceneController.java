...
import com.perezcalle.songlibrary.Song;
...
public class MainSceneController {
	...
	public void sortList(ObservableList<Song> obsList) {
		Comparator<Song> compareTitle = Comparator.comparing(Song::getTitle).thenComparing(Song::getArtist);
		obsList.sort(compareTitle);
	}
}
